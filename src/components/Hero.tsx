  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 to-white py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* GRID: image goes below on mobile, side-by-side on desktop */}
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-8 max-w-xl">
              We connect skilled professionals with leading companies in the warehouse
              and logistics industry. Whether you're seeking top talent or your next
          ...
          {/* IMAGE SECTION — mobile-friendly placement */}
          <div className="w-full">
            <div className="rounded-2xl overflow-hidden shadow-2xl mx-auto max-w-md sm:max-w-lg lg:max-w-full">
