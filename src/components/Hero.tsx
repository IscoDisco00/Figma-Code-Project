...
export function Hero() {
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-50 to-white pb-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

        {/* FULL-WIDTH IMAGE ONLY ON MOBILE */}
        <div className="lg:hidden -mx-4 sm:-mx-6 mb-12">
